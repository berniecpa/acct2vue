...
<form action="#">
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label>Country</label>
													<vue-select :options="editcustomerbillingcountry" />
												</div>
												<div class="form-group">
													<label>City</label>
...
<script>
  ...
  export default {
     data() {
    return {
      editcustomerbillingcountry: ["Afghanistan", "Albania", "Algeria", "American Samoa", "Andorra", "Angola", "Anguilla", "United States"]
